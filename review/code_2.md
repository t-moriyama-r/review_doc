...
>   - [例：WhatではなくWhyを意識](#例WhatではなくWhyを意識)<br>
> - [ネストを下げる意識](#ネストを下げる意識)<br>
>   - [例：早期リターン](#例早期リターン)<br>
>   - [例：関数分割でネストを下げる](#例関数分割でネストを下げる)<br>
> - [条件分岐の工夫](#条件分岐の工夫)<br>
>   - [例：離れたelseはなるべく使わない(とにかく近くに置く意識)](#例離れたelseはなるべく使わないとにかく近くに置く意識)<br>
> - [関数について](#関数について)<br>
>   - [例：多すぎる引数](#例多すぎる引数)<br>
>   - [例：1要素で説明できない関数は危険信号](#例1要素で説明できない関数は危険信号)<br>
>   - [例：安易なプリミティブ型は一呼吸おいて考える](#例安易なプリミティブ型は一呼吸おいて考える)<br>
> - [N+1問題を意識しているか？](#N+1問題を意識しているか)<br>
> - [引数の定義に意思はあるか？](#引数の定義に意思はあるか)
>   - [例：オブジェクト引数パターン](#例オブジェクト引数パターン)<br>
>   - [例：逆に位置引数が正当化される・活かされるパターン](#例逆に位置引数が正当化される・活かされるパターン)<br>
> - [とにかくイミュータブルを意識する](#とにかくイミュータブルを意識する)
>   - [例1：後から変わる変数](#例1後から変わる変数)<br>
>   - [例2：意図せぬ副作用](#例2意図せぬ副作用)<br>
> - [スコープについての理解](#スコープについての理解)
>   - [Step1：とにかくすべてをprivateにする](#Step1とにかくすべてをprivateにする)<br>
>   - [Step2：package化](#Step2package化)<br>
> - [ジェネリクスを活用する](#ジェネリクスを活用する)
>   - [例：テーブルの中身を限定する](#例テーブルの中身を限定する)<br>
